...
|-------|-------------|------------|--------|
| [01-core-types-and-generators](phases/01-core-types-and-generators.md) | Add RawSessionID, HashedSessionID types, SessionIDGenerator, SessionIDHasher, default implementations, functional options, and context helpers | None | Pending |
